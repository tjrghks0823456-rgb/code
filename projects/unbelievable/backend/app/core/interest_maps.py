...
RAW_CATEGORY_MAP = {
    ...
    "pets & animals": ("라이프스타일", "반려동물"),
    "comedy": ("엔터테인먼트", "예능/인물"),
    "autos & vehicles": ("라이프스타일", "생활"),
    "nonprofits & activism": ("정치/사회", "사회이슈/사건"),
    "beauty & fitness": ("건강/운동", "건강관리"),
    "books & literature": ("학습/자격증", "교양/인문/과학"),
    "business & industrial": ("경제/금융", "재테크"),
    "food & drink": ("여행/맛집", "맛집/카페"),
    "hobbies & leisure": ("라이프스타일", "생활"),
    "home & garden": ("라이프스타일", "생활"),
    "internet & telecom": ("IT/테크", "기타 IT"),
    "jobs & education": ("학습/자격증", "자격증"),
    "law & government": ("정치/사회", "사회이슈/사건"),
    "online communities": ("라이프스타일", "일상"),
    "people & society": ("정치/사회", "사회이슈/사건"),
    "real estate": ("경제/금융", "부동산"),
