...
INTEREST_RULES = [
    ...
    {"category": "엔터테인먼트", "subcategory": "음악/아이돌", "keywords": ["음악", "노래", "뮤직", "아이돌", "밴드", "락", "힙합", "락힙합", "ost", "딘딘", "리센느", "여돌", "스텔라이브", "정국", "뉴진스", "아이브", "세븐틴"]},
    {"category": "엔터테인먼트", "subcategory": "영화/드라마", "keywords": ["영화", "드라마", "예고편", "넷플릭스", "ott"]},
    {"category": "엔터테인먼트", "subcategory": "예능/인물", "keywords": ["예능", "인터뷰", "김호영", "박명수", "유재석", "유병재", "강동원", "정지훈", "배우", "천만 배우", "수상소감", "웃긴", "침착맨", "라이브"]},
