...
| `UC_EquipmentList` | 장비 목록, 검색, 상세 스펙/가이드, 신규 등록/삭제 |
...
이 프로젝트는 WinForms 화면 구성뿐 아니라 DB 연동, 장비 등록/삭제, 상태 전환, 이력 기록, 검색, 일정 관리까지 포함합니다. 그래서 단일 화면 실습보다 한 단계 더 나아간 "작은 업무용 관리 프로그램"으로 보여줄 수 있습니다.
